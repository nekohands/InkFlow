...
contains "$work_dir/reader.html" 'href="/admin/operations#collection"'
contains "$work_dir/reader.html" 'href="/admin/operations#packages"'
contains "$work_dir/reader.html" 'href="/admin/operations#sources"'
...
contains "$work_dir/operations.html" 'href="/admin/operations#collection"'
contains "$work_dir/operations.html" 'href="/admin/operations#packages"'
contains "$work_dir/operations.html" 'href="/admin/operations#sources"'
...
contains "$work_dir/operations.html" 'bookTitle'
contains "$work_dir/operations.html" '采集地址：'
contains "$work_dir/operations.html" 'operations-run-card__summary'
contains "$work_dir/operations.html" 'captureDetailsOpenState'
contains "$work_dir/operations.html" 'restoreDetailsOpenState'
contains "$work_dir/operations.html" 'data-operations-details-key'
contains "$work_dir/operations.html" 'node("details"'
contains "$work_dir/operations.html" 'operations-package-card'
contains "$work_dir/operations.html" 'operations-card'
contains "$work_dir/operations.html" 'operations-policy-card'
...
contains "$work_dir/operations.html" '重试'
contains "$work_dir/operations.html" '清理已取消任务'
contains "$work_dir/operations.html" 'cancelled-cleanup'
contains "$work_dir/operations.html" '/api/v1/admin/collection-runs/cancelled/cleanup'
...
contains "$work_dir/operations.html" 'operations-action-suggestions'
contains "$work_dir/operations.html" '常用理由'
contains "$work_dir/operations.html" 'reasonSuggestionsFor'
contains "$work_dir/operations.html" '可直接选择、修改或自行填写'
contains "$work_dir/operations.html" 'data-reason-suggestion'
contains "$work_dir/operations.html" '任务已不再需要继续执行'
